...
//       sx={{ 
//         height: '100vh', 
//         width: '50vw', // Garante metade da tela
//         overflow: 'hidden' 
//       }}
//     >
//       <img 
...
//       sx={{ 
//         height: '100vh',
//         width: '50vw', // Também metade da tela
//         display: 'flex',
//         alignItems: 'center',
...
//           sx={{ width: '100%' }}
//         >
//           {/* Seus TextFields e Botão seguem aqui... */}
...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log(response.data); // Exibe a resposta do servidor (mensagem de sucesso)
